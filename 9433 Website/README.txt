...
sub-directory and 4 html files.
...
midterms.html - the page that contains all the midterm topics.

finals.html - the page that contains all the final topics.
...
"Start Lesson" inline with the brief description of the midterm topics. 
 ...
 To view the prelim page you can either click "FINALS" on the navbar or click
"Start Lesson" inline with the brief description of the prelim topics.
